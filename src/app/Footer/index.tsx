            ...
            <Grid container spacing={4} sx={{ textAlign: "center" }}>
              ...
              <Grid item xs={12} md={12} sx={{ order: { xs: 1, md: 0 } }}>
                ...
                <Typography sx={{ mb: 3, maxWidth: 400, mx: "auto" }}>
                  Our company is dedicated to providing high-quality mechanical
                  and electrical products that meet the diverse needs of our
                  clients.
                </Typography>
            ...
            >
              ...
              >
                ...
                <Typography width={200}>
                  Fourth Floor 5227, Nigam Market G.B Road, Ajmeri Gate,
                  Delhi-110006
                </Typography>
              </Stack>
              <Stack
                ...
                spacing={1}
                component="a"
                href="mailto:industrialventures21@gmail.com"
                sx={{
                  color: "white",
                }}
              >
        ...
        <Box sx={{ bgcolor: "black", color: "white", py: 6 }}>
          <Container maxWidth="lg">
            <Grid container spacing={4}>
             ...
             <Link href="#" style={{ color: 'white', textDecoration: "none" }}>
              ...
              <Grid
                ...
                xs={12}
                md={6}
                sx={{ textAlign: "center", p: 2, borderRadius: 2 }}
              >
                <Box
                  sx={{
                    mb: 2,
            ...
            >
              ...
              >
                <LocationOn />
                <Typography width={280}>
                  Fourth Floor 5227, Nigam Market G.B Road,
              ...
              >
                <Email />
                <Typography width={300}>industrialventures21@gmail.com</Typography>
              </Stack>
